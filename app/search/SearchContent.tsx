  ...
  return (
    <div style={{ padding: '24px 0 80px', minHeight: '70vh' }}>
      ...
      <div style={{ background: 'var(--deep)', padding: '40px 24px 48px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, opacity: 0.04, fontSize: 200, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--gold)', pointerEvents: 'none' }} aria-hidden>🔍</div>
        ...
        <div className="container" style={{ maxWidth: 640, position: 'relative' }}>
          ...
          />
          <span style={{ position: 'absolute', right: 18, top: '50%', transform: 'translateY(-50%)', fontSize: 22, pointerEvents: 'none' }}>
            {loading ? <span className="spinner" style={{ color: 'var(--text-muted)' }} /> : '🔍'}
          </span>
        </div>
