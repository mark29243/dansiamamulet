...
const FAQ = {
  th: [
    { q: 'พระเครื่องของเราแท้จริงหรือไม่?', a: 'ใช่ครับ ทุกองค์มีใบรับรองความแท้และผ่านการตรวจสอบจากผู้เชี่ยวชาญที่มีประสบการณ์มากกว่า 20 ปี' },
    ...
    { q: 'หากพระเครื่องไม่ถูกใจ สามารถคืนได้ไหม?', a: 'รับคืนภายใน 7 วันหลังรับสินค้า โดยพระเครื่องต้องอยู่ในสภาพเดิม พร้อมใบรับรองและบรรจุภัณฑ์' },
    ...
    { q: 'พระเครื่องนี้?', a: 'แต่ละองค์มาพร้อมคำแนะนำการบูชาภาษาไทย/อังกฤษ/จีน ทั้งคาถาและพิธีการเบื้องต้น' },
