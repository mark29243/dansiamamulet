...
const CONTENT = {
  th: {
    ...
    sections: [
      {
        title: 'ความเป็นมา',
        body: 'แดนสยามก่อตั้งขึ้นด้วยความตั้งใจที่จะเป็นสะพานเชื่อมระหว่างวัฒนธรรมพุทธไทยและผู้ศรัทธาทั่วโลก เราคัดสรรพระเครื่องแท้ทุกองค์ด้วยตัวเองจากวัดดังทั่วประเทศไทย โดยร่วมงานโดยตรงกับครูบาอาจารย์ผู้สร้าง',
      },
      {
        title: 'การรับรองความแท้',
        body: 'พระเครื่องของเราผ่านการตรวจสอบจากผู้เชี่ยวชาญที่มีประสบการณ์มากกว่า 20 ปี ทุกองค์มาพร้อมใบรับรองความแท้ที่ระบุรายละเอียดวัด ปี และที่มาอย่างชัดเจน',
      },
      {
