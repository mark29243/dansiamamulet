...
export default function AdminProductTable({ products }: { products: any[] }) {
  ...
  function exportShopee() {
    ...
    for (const p of selectedProds) {
      ...
      row[34] = 'เปิด';
      // 38: ผ่อนชำระผ่านบัตรเครดิต (Installment via credit card)
      row[38] = price >= 1000 ? 'เปิด' : 'ปิด';
