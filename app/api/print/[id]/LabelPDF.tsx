    ...
    <Document>
      <Page size={[W, H]} style={s.page}>
        ...
        <View style={dynamicToBoxStyle}>
          ...
          <Text style={{ ...s.toAddress, fontSize: ((fullAddress.match(/\n/g) || []).length > 5 || fullAddress.length > 120) ? 7.5 : 9.5, lineHeight: ((fullAddress.match(/\n/g) || []).length > 5 || fullAddress.length > 120) ? 1.15 : 1.4, fontFamily: getFontFamily(fullAddress) }}>
            {addr.line1}
