...
async function main() {
  console.log("=== June Image Sync Bot ===");

  console.log("กำลังดึงข้อมูลสินค้าจากฐานข้อมูล (june_products)...");
  ...
  // We just use all products in june_products
  ...
  // Use a local folder for the bot's Chrome profile
  const userDataDir = path.join(process.cwd(), 'chrome_profile_june_shopee');
