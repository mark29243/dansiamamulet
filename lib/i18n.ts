...
export const categoryNames: Record<string, { th: string; en: string; zh: string }> = {
  ...
  'เหรียญเกจิ':          { th: 'เหรียญเกจิ',          en: 'Monk Coin',        zh: '高僧圣币' },
  'เหรียญพระพุทธ':      { th: 'เหรียญพระพุทธ',      en: 'Buddha Coin',      zh: '佛陀圣币' },
  ...
  'พระขุนแผน':          { th: 'พระขุนแผน',          en: 'Phra Khun Phaen',  zh: '坤平佛牌' },
...
export const CAT_SLUG: Record<string, string> = {
  ...
  'พระผง':               'phra-phong',
  'พระรอด':              'phra-rod',
  'เหรียญเกจิ':          'rian-kejii',
  'เหรียญพระพุทธ':      'rian-phra-phut',
  'รูปหล่อ':             'rup-lor',
