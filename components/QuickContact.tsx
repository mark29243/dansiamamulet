...
const CONTACTS: Contact[] = [
  ...
  { id: 'wechat', label: 'WeChat', icon: <IcoChat size={18} />, color: '#7BB32E', href: 'weixin://dl/chat?jarunpim', desc: { th: 'แชทผ่าน WeChat', en: 'Chat on WeChat', zh: '微信聊天' }, qr: '/wechat-qr.jpg' },
